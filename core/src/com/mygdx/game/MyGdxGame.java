...
/**
 * Game method that extends ApplicationAdapter and implements InputProcessor.
 * The main class from which all other methods are called.
 */
public class MyGdxGame extends ApplicationAdapter implements InputProcessor {
    ...
    /**
     * Method which creates an instance of MyGdxGame and all required additional classes
     */
    private MyGdxGame() {
    ...
    /**
     * Method used to create a singleton instance of MyGdxGame
     */
    ...
    /**
     * Method used to return a singleton instance of MyGdxGame
     *
     * @return Returns a singleton instance of MyGdxGame
     */
    ...
    /**
     * Method which creates an instance of SpriteBatch and calls the render methods of all classes on it
     */
    @Override
    public void render() {
    ...
    /**
     * Disposes of as many things as possible to make the game run more smoothly
     */
    @Override
    public void dispose() {
        batch.dispose();
        ...
        img4.dispose();
        img5.dispose();
        movebuttonleft.dispose();
        movebuttonup.dispose();
        movebuttonright.dispose();
        movebuttondown.dispose();
        missile.dispose();
    ...
    /**
     * Method which checks if the screen is pressed and uses this to act accordingly
     *
     * @param screenX X coordinate of where the screen is touched
     * @param screenY Y coordinate of where te screen is touched
     * @param pointer Integer to differentiate between multiple touches
     * @param button  Type of button being pressed
     * @return Returns true if the method is called
     */
    @Override
    ...
    /**
     * Methods which checks if the screen is no longer being touched
     *
     * @param screenX X coordinate of where the screen is touched
     * @param screenY Y coordinate of where te screen is touched
     * @param pointer Integer to differentiate between multiple touches
     * @param button  Type of button being unpressed
     * @return Returns true if the method is called
     */
    @Override
